            ...
            <div class="col-md-5">
                ...
                <div class="form-group row">
                    ...
                    <select id="matkul" name="matkul" class="custom-select" required>
                        <option value="pw">Pilih Mata Kuliah</option>
                ...
                <div class="form-group row g-3">
                    ...
                    <div class="col-8">
                    <input id=" uts" name=" uts" type="number" class="form-control-sm" placeholder="Nilai UTS" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="uas" class="col-4 col-form-label">Nilai UAS</label> 
                    <div class="col-8">
                    <input id="uas" name="uas" type="number" class="form-control-sm" placeholder="Nilai UAS" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="tugas" class="col-4 col-form-label">Tugas / Praktikum</label> 
                    <div class="col-8">
                    <input id="tugas" name="tugas" type="number" class="form-control-sm" placeholder="Nilai Tugas/Praktikum" required>
                    </div>
                </div> 
                <div class="form-group row">
